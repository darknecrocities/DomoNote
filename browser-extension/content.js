// DomoNote Google Meet Integration Content Script
// Strictly non-intrusive, requires explicit user interaction to trigger capture.
...
(function () {
  ...
  function injectDomoNoteButton() {
    ...
    text.textContent = 'DomoNote: Open Workspace';
