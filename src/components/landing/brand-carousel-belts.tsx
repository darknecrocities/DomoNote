...
const VIDEO_PLATFORMS = [
  ...
  },
  {
    id: 'skype',
    name: 'Skype',
    fontStyle: 'font-sans font-bold text-[#00AFF0] tracking-tight',
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6 shrink-0" fill="#00AFF0">
        <path d="M12.067 0C7.29 0 3.328 3.388 2.457 7.915 1.05 9.07.156 10.825.156 12.784c0 3.738 2.875 6.828 6.536 7.15C7.94 22.128 10.667 24 13.933 24c4.776 0 8.738-3.388 9.609-7.915 1.407-1.155 2.301-2.91 2.301-4.869 0-3.738-2.875-6.828-6.536-7.15C18.06 1.872 15.333 0 12.067 0zm.075 4.59c3.96 0 5.626 2.015 5.626 3.914 0 1.954-1.42 2.873-2.919 3.473l-2.617 1.026c-.846.335-1.439.732-1.439 1.348 0 .762.695 1.365 1.892 1.365 2.766 0 3.196-1.597 4.148-1.597.472 0 .913.313.913.805 0 1.258-2.023 2.842-5.061 2.842-3.312 0-5.69-1.748-5.69-4.043 0-1.61 1.087-2.782 2.97-3.528l2.673-1.047c.694-.271 1.293-.654 1.293-1.253 0-.693-.687-1.228-1.677-1.228-2.348 0-2.868 1.403-3.766 1.403-.426 0-.853-.298-.853-.805 0-1.398 2.016-2.705 4.51-2.705z" />
      </svg>
    ),
  },
  {
...
export const BrandCarouselBelts: React.FC = () => {
  ...
  return (
    <div className="w-full py-6 my-2 relative overflow-hidden flex flex-col gap-3.5 select-none">
      ...
      <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-24 sm:w-44 z-20 bg-gradient-to-r from-[var(--bg-page)] to-transparent" />
      <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-24 sm:w-44 z-20 bg-gradient-to-l from-[var(--bg-page)] to-transparent" />
