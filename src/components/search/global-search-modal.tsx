      ...
      <div className="space-y-4">
        <div className="relative">
          ...
          <input
            ...
            autoFocus
            className="w-full bg-zinc-900 border border-zinc-800 rounded-lg pl-10 pr-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 focus:outline-none focus:border-zinc-700"
          />
        </div>
            ...
            results.map((hit) => {
              ...
              return (
                <div
                  ...
                  className="p-3.5 rounded-lg bg-zinc-900/60 border border-zinc-850 hover:bg-zinc-850 hover:border-zinc-700 cursor-pointer transition-colors text-xs flex items-center justify-between"
                >
                  <div className="flex items-start gap-3 min-w-0">
                    <Icon className="w-4 h-4 text-zinc-400 mt-0.5 shrink-0" />
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        <span className="font-semibold text-zinc-100 truncate">{hit.title}</span>
                        <span className="text-[10px] text-zinc-400 bg-zinc-950 px-1.5 py-0.2 rounded border border-zinc-850 uppercase">
                          {hit.type}
                        </span>
                      </div>
                      <p className="text-zinc-400 line-clamp-1">{hit.snippet}</p>
                    </div>
                  </div>
