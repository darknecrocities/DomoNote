...
export const MeetingsView: React.FC = () => {
  ...
  return (
    <div className="flex h-full w-full overflow-hidden bg-slate-50 dark:bg-black transition-colors duration-200">
      {/* Left Sidebar: Sessions List */}
      <div
        className={`${
          isDetailOpen ? 'hidden md:flex' : 'flex'
        } w-full md:w-80 border-r border-slate-200 dark:border-zinc-850 flex-col h-full bg-white dark:bg-zinc-950 shrink-0 select-none transition-colors duration-200`}
      >
