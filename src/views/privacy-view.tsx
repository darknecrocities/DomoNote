  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-black p-8 overflow-y-auto max-w-4xl mx-auto w-full select-none">
      <div className="border-b border-zinc-850 pb-5 mb-8">
        <h2 className="text-2xl font-bold text-white tracking-tight">Privacy & Local-First Boundaries</h2>
      ...
      <div className="space-y-6 text-xs text-zinc-300 leading-relaxed">
        ...
        <div className="bg-zinc-950 border border-zinc-850 rounded-xl p-6 space-y-3">
          ...
          <ul className="space-y-2 text-zinc-400">
            <li>
              <strong>Microphone:</strong> Invoked exclusively when you click "Start Microphone" in
              the Meeting Secretary. The browser will ask for confirmation, and an active red pulse
              indicator will show during recording.
            </li>
            <li>
              <strong>Screen Sharing:</strong> Invoked exclusively when you click "Start Screen
              Capture" in the Operation Manual section. You choose which window or screen to share.
            </li>
            <li>
              <strong>No Silent Recording:</strong> DomoNote does not and cannot bypass browser
