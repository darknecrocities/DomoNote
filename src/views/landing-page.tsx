  ...
  return (
    <div className="min-h-screen bg-[#050505] text-zinc-100 flex flex-col font-sans selection:bg-zinc-800 selection:text-white relative overflow-x-hidden">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 pt-10 pb-24 relative z-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center pt-6 pb-20 border-b border-zinc-850/60 mb-20">
          {/* Left Column: Text Content & Actions */}
          <div className="lg:col-span-7 flex flex-col items-start text-left space-y-6">
            {/* Top Benefit Badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-zinc-900/90 border border-zinc-800 text-xs text-zinc-300 select-none shadow-sm">
          ...
          {/* Right Column: Prominent Standalone Mascot (No cards on it!) */}
          <div className="lg:col-span-5 flex items-center justify-center relative select-none">
            {/* Subtle Ambient Backlight Glow */}
            <div className="absolute w-72 h-72 sm:w-96 sm:h-96 rounded-full bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.06)_0,transparent_70%)] pointer-events-none blur-2xl" />
            ...
            <div
              ...
              onClick={() => playPop()}
              onMouseEnter={() => playThock(1.2)}
              title="DomoNote Note-Taking Mascot"
            >
              <img
                src={pandaImg}
                alt="DomoNote Panda Mascot"
                className="w-72 h-72 sm:w-96 sm:h-96 lg:w-[450px] lg:h-[450px] object-contain filter drop-shadow-[0_20px_40px_rgba(255,255,255,0.08)] animate-float"
        ...
        <ScrollReveal direction="up" delayMs={50}>
          <div id="demo-video-section" className="w-full py-10 text-left mb-28 scroll-mt-20">
